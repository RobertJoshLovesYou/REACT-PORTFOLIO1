      ...
      <div className="container contact">
        ...
        <div>
          <ul className="social-icons">
            <li><a href="https://web.facebook.com/jazzburn91104" target="_blank" rel="noreferrer"><i className="bi bi-facebook"></i></a></li>
            <li><a href="https://www.instagram.com/joshyy_ss/"  target="_blank" rel="noreferrer"><i className="bi bi-instagram"></i></a></li>
          </ul>
        </div>
        <div className="columns">
          <div className="column contact-box">
            ...
            <p>Quezon Prov<br />Lucena City, Isabang, Inmacualada</p>
          </div>
          <div className="column contact-box">
          <h3>Email</h3>
          <i className="bi bi-envelope icon"></i>
          <p>connie91104@gmail.com</p>
          </div>
          <div className="column contact-box">
          <h3>Call Me</h3>
